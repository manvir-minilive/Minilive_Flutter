...
class AppleSignup extends StatefulWidget {

  @override
  _AppleSignupState createState() => _AppleSignupState();
}

class _AppleSignupState extends State<AppleSignup> {
          ...
          children: <Widget> [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  "Sign Up - Apple ID",style: TextStyle(color:Colors.white, fontSize: 30,),),
              ),
            ),
            // SizedBox(height: 5),
            Center(
